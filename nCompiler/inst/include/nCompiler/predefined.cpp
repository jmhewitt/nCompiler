...
// SparseCholesky
//--------------------------------------
#ifndef __SparseCholesky_CPP
#define __SparseCholesky_CPP
// preamble to enable Eigen errors
#ifndef NCOMPILER_EIGEN_ERRORS_ENABLED
#define NCOMPILER_EIGEN_ERRORS_ENABLED
...
// [[Rcpp::export]]
SEXP  new_SparseCholesky (  )  {
RESET_EIGEN_ERRORS
return(loadedObjectEnv(new_nCompiler_object<SparseCholesky>()));
}

NCOMPILER_INTERFACE(
SparseCholesky,
NCOMPILER_FIELDS(
field("R", &SparseCholesky::R),
field("P", &SparseCholesky::P)
),
NCOMPILER_METHODS()
)
#endif
