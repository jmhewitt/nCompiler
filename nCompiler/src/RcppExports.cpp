...
RcppExport SEXP _nCompiler_new_SparseCholesky() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    rcpp_result_gen = Rcpp::wrap(new_SparseCholesky());
    return rcpp_result_gen;
END_RCPP
}
// rcpp_hello_world
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_nCompiler_new_SparseCholesky", (DL_FUNC) &_nCompiler_new_SparseCholesky, 0},
