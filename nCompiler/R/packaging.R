...
## Returns a generic header string for auto-generated functions.
headerString <- function(pkgName) {
  paste0('## Generated by nCompiler::nWritePackage() for package ', pkgName, '\n##   -> do not edit by hand\n')
}
